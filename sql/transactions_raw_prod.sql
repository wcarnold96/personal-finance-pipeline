CREATE EXTERNAL TABLE `transactions_raw_prod`(
  `change_type` string,
...
LOCATION
  's3://YOUR_BUCKET_NAME/raw/transactions/env=production'
TBLPROPERTIES (
  ...
  'storage.location.template'='s3://YOUR_BUCKET_NAME/raw/transactions/env=production/sync_date=${sync_date}')
