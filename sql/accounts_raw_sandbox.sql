CREATE EXTERNAL TABLE `accounts_raw_sandbox`(
  `institution` string,
...
LOCATION
  's3://YOUR_BUCKET_NAME/raw/accounts/env=sandbox'
TBLPROPERTIES (
  ...
  'storage.location.template'='s3://YOUR_BUCKET_NAME/raw/accounts/env=sandbox/sync_date=${sync_date}')
